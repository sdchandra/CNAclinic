...
```
    ...
    ## [25] R.oo_1.21.0                            
    ## [26] pcaPP_1.9-72                           
    ## [27] TxDb.Hsapiens.UCSC.hg38.knownGene_3.4.0
    ## [28] XML_3.98-1.9                           
    ## [29] pkgconfig_2.0.1                        
    ## [30] biomaRt_2.30.0                         
    ## [31] zlibbioc_1.20.0                        
    ...
    ## [33] mvtnorm_1.0-6                          
    ## [34] scales_0.5.0                           
    ## [35] chemometrics_1.4.2                     
    ## [36] BiocParallel_1.8.2                     
    ## [37] tibble_1.3.4                           
    ## [38] annotate_1.52.1                        
    ## [39] IRanges_2.8.2                          
    ## [40] ggplot2_2.2.1                          
    ## [41] SummarizedExperiment_1.4.0             
    ## [42] GenomicFeatures_1.26.4                 
    ## [43] lazyeval_0.2.1                         
    ## [44] nnet_7.3-12                            
    ...
    ## [48] memoise_1.1.0                          
    ## [49] evaluate_0.10.1                        
    ## [50] R.methodsS3_1.7.1                      
    ## [51] MASS_7.3-47                            
    ## [52] class_7.3-14                           
    ## [53] data.table_1.10.4-3                    
    ## [54] tools_3.3.3                            
    ## [55] org.Hs.eg.db_3.4.0                     
    ## [56] matrixStats_0.52.2                     
    ## [57] stringr_1.2.0                          
    ## [58] S4Vectors_0.12.2                       
    ## [59] munsell_0.4.3                          
    ## [60] bindrcpp_0.2                           
    ## [61] AnnotationDbi_1.36.2                   
    ## [62] Biostrings_2.42.1                      
    ## [63] pls_2.6-0                              
    ## [64] som_0.3-5.1                            
    ## [65] e1071_1.6-8                            
    ## [66] GenomeInfoDb_1.10.3                    
    ## [67] QDNAseq.hg19_1.4.0                     
    ## [68] CGHbase_1.34.0                         
    ## [69] rlang_0.1.4                            
    ## [70] grid_3.3.3                             
    ## [71] RCurl_1.95-4.8                         
